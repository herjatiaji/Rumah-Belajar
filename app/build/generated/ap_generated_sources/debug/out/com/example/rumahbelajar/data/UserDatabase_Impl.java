package com.example.rumahbelajar.data;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoUser.equals(_existingUser)) {
          return new RoomOpenHelper.ValidationResult(false, "user(com.example.rumahbelajar.data.User).\n"
                  + " Expected:\n" + _infoUser + "\n"
                  + " Found:\n" + _existingUser);
        }
        ...
        if (! _infoAttempt.equals(_existingAttempt)) {
          return new RoomOpenHelper.ValidationResult(false, "attempt(com.example.rumahbelajar.data.Attempt).\n"
                  + " Expected:\n" + _infoAttempt + "\n"
                  + " Found:\n" + _existingAttempt);
        }
